...
Your task is to **deeply review** the codebase and produce a **written report (in Markdown)** that:
...
You don’t have to write a novel, but each section should be **substantive** enough that another developer could read your report and quickly understand the codebase and its main issues.
...
1. Find the right set of files in the repo and:
...
2. Search for:
   ...
   * Relevant names in code, docs, and configs
...
* **Inbound dependencies** – Who calls each module?

  * Which services, components, or modules depend on it?

* **Outbound dependencies** – Who does each module call?
...
Within each module, identify and list:
...
### Step 6 – Evaluate the Architecture & Design
